...
//        [self setProxy:[SDLProxyFactory buildSDLProxyWithListener:self]];
        ...
        [self setProxy:[SDLProxyFactory buildSDLProxyWithListener:self tcpIPAddress:@"19.56.72.53" tcpPort:@"2776"]];
    }
}
...
- (void)handleWeatherDataUpdate:(NSNotification *)notification {
    ...
    [formatterShow setDateFormat:@"MM/d h a"];
    ...
    [formatterSpeak setDateFormat:@"d. 'of' MMMM, h a"];
